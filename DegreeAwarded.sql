select distinct a.EMPLID,a.ACAD_PROG,a.ACAD_PLAN,a.ACAD_PLAN_TYPE,a.CIP_CODE_PLAN,a.CIP_CODE_SUB_PLAN,a.DEGREE,a.DESCR_FORMAL,b.EDUCATION_LVL,b.DEGREE_DESCR,
